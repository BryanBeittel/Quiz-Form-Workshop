document.getElementById('formButton').onclick=function(){
    ...
    result = q1 + q2 + q3 + q3 + q4 + q5 + q6 + q7 + q8 + q9;
    let result2;

    document.getElementById('grade').innerHTML = "<h1>How smart are you Assessment?</h1><p>Thanks for taking this Assessment!<br><i>If you entered your email address at the beginning, you will receive an email with your results.</i><br>Here are your results.</p><h3>Your Total Score is: " + result + "</h3><p>Read below for an analysis of your score level to discover how far you got in your journey. <br> Remember you can always grow in your skills by working hard and practicing a lot.</p>"

    if(result <=9) {
        result2 = "<b>Your score of " + result + "</b> may indicate that you have never studied or you are at the beginning of your programming journey."
    }
    ...
    if(result >18 && result < 27) {
        result2 = "<b>Your score of " + result + "</b> may indicate that you are a seasoned developer and we encourage you to continue your programming journey."
    }
    if(result >26 && result < 36) {
        result2 = "<b>Your score of " + result + "</b> may indicate that you are a professional developer and we encourage you to continue your programming journey."
    }
    ...
    document.getElementById('htmlGrade'),innerHTML = "Your score for the HTML Category is: " + htmlResult + "<i>(out of 12)</i>"
    if(htmlResult >=0){
        htmlResult2 = "<b><i>Overview</i></b> <br><br>The points obtained here will show you the level you have to invest in studying HTML.  If your result is under 4, you better start working harder on this.  But take one day at a time."
